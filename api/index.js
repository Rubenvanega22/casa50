...
async function apiMonthMetrics(p, res) {
  ...
  supabase.from('sales').select('business_day,shift_id,type,total,pay_method,extra_people_value,amount_1,amount_2,amount_3,people,user_name,room_id,duration_hrs').like('business_day', ym+'%').order('ts_ms',{ascending:true}).limit(50000),
  ...
  supabase.from('room_products').select('business_day,shift_id,pay_method,total,is_cortesia').like('business_day', ym+'%').order('ts_ms',{ascending:true}).limit(50000),
